...
export default function TrendingSection({ savedMovies, toggleMyList }) {
  ...
  return (
    <section className="px-2 py-[5px] md:px-16 md:py-[30px]">
      <h3 className="text-white text-[20px] font-bold md:text-[32px]">Film Trending</h3>
      ...
      <div className="relative group">
        ...
        <div className="flex gap-4 overflow-x-auto scroll-smooth scrollbar-hide py-6" id="trendingSlider" ref={sliderRef} style={{ scrollbarWidth: 'none' }}>
